...
track_list = ("Austin", "BrandsHatch", "Budapest", "Catalunya", "IMS", "Melbourne", "MexicoCity", "Monza", "MoscowRaceway", "Nuerburgring", "Oschersleben", "Sakhir", "SaoPaulo", "Sepang", "Silverstone", "Sochi", "Spielberg")

#Load all the tracks from tracks folder
#file_paths["track_name"] = "Austin" + "_centerline"                                
...
# iterate through all the optimization type, output the results and plot the results then go 
# to the next optimization type
#for opt in ["shortest_path", "mincurv_iqp", "mintime"]:
for opt in ["shortest_path", "mincurv_iqp"]:
    opt_type = opt
    for track in track_list:
        file_paths["track_name"] = track + "_centerline"
        print("INFO: Track:", file_paths["track_name"])
        print("INFO: Starting optimization with type:", opt_type)
